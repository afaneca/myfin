  ...
  renderRow: trx => {
    return `
            <tr data-id='$trx.transaction_id'>
                ...
                <td>${trx.is_essential == true ? '<span class="badge white-text purple-gradient-bg" data-badge-caption="Essencial"></span>' : ''}  ${trx.description}<p><i class="inline-icon material-icons">folder_shared</i>  ${(trx.category_name) ? trx.category_name : '<span class=\'medium-gray-color\'>Sem Categoria</span>'}&nbsp;&nbsp;&nbsp;<i class="inline-icon material-icons">business</i> ${(trx.entity_name) ? trx.entity_name : '<span class=\'medium-gray-color\'>Sem Entidade</span>'}</p></td>

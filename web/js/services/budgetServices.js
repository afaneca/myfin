export const BudgetServices = {
    ...
    addBudget: (month, year, observations, catValuesArr, successCallback, errorCallback) => {
    ...
    editBudget: (budgetID, month, year, observations, catValuesArr, successCallback, errorCallback) => {
        var pageUrl = REST_SERVER_PATH + "budgets/"

...
class EnsoShared {
	 ...
	 */
	public static $REST_OK = 200;
	public static $REST_CREATED = 201;
	public static $REST_UPDATE_DELETED = 202;
	public static $REST_BAD_REQUEST = 400;
	public static $REST_NOT_AUTHORIZED = 401;
	public static $REST_FORBIDDEN = 403;
	public static $REST_NOT_FOUND = 404;
	public static $REST_NOT_ACCEPTABLE = 406;
	public static $REST_INTERNAL_SERVER_ERROR = 500;

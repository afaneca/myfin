...
var TransactionServices = {
  ...
  editTransaction: (trxID, new_amount, new_type, new_description, new_entity_id, new_account_from_id, new_account_to_id, new_category_id, new_date_timestamp, new_is_essential,
    ...
    if (new_type !== MYFIN.TRX_TYPES.EXPENSE) new_is_essential = false;
    if (split_type !== MYFIN.TRX_TYPES.EXPENSE) split_is_essential = false;
  ...
  autoCategorizeTrxByDescription: (description, successCallback, errorCallback) => {
    var pageUrl = REST_SERVER_PATH + 'trxs/auto-cat-description';
